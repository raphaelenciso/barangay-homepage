...
const Feature = () => {
  return (
    <div className="w-full bg-[#EBF5FF] text-[#1E2241] dark:bg-[#1E2241] dark:text-white p-6">
      <div className="max-w-6xl mx-auto p-16 bg-[#FFFFFF] dark:bg-[#34385F] text-[#1E2241] dark:text-white  flex flex-col justify-center items-center rounded-tl-2xl rounded-br-2xl">
        ...
        <div className="flex gap-0 px-20 pt-20 justify-center items-center | lg:gap-20 ">
          <div className="flex flex-col">
            {/* card */}
            <div className="flex flex-col px-12 pb-4 w-[25rem] bg-[#07081C] text-white dark:bg-[#F1EDFF] dark:text-black rounded-tl-3xl rounded-br-3xl">
            ...
            {/* card */}
            <div className="flex flex-col px-12 pb-4 mt-8 w-[25rem] dark:bg-[#07081C] bg-[#F1EDFF] rounded-tl-3xl rounded-br-3xl">
